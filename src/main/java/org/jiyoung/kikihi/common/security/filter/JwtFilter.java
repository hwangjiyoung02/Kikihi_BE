...
//        CustomUserDetails customUserDetails=new CustomUserDetails(User.from(email,role));
...
//        Authentication authentication = new UsernamePasswordAuthenticationToken(email,customUserDetails);
